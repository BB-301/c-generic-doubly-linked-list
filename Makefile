...
docs_for_website:
	...
	docker run \
    	--rm \
    	-v $(CURRENT_DIRECTORY):/my-dir \
		-v $(CURRENT_DIRECTORY)/../c-generic-doubly-linked-list-docs/docs/v$(LIB_VERSION):/my-dir/build-doxygen \
    	-w /my-dir \
		-e DOXYGEN_PROJECT_NUMBER=$(LIB_VERSION) \
    	$(DOCKER_DOXYGEN_IMAGE_NAME) doxygen doxygen/Doxyfile
...
help:
	...
	@echo "\n- make docs_for_website\n\tBuilds the Doxygen website using Docker and outputs the result into '../c-generic-doubly-linked-list-docs/docs/v$(LIB_VERSION)'."
